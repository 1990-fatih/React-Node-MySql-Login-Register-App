...
app.post("/addFrage", (req, res) => {
  const sql =
    "INSERT INTO fragen1 (`frageText`,`antwort1`,`antwort2`,`antwort3`,`antwort4`,`correct`) VALUES(?)";
...
app.delete("/deleteUser/:id",(req,res)=>{
  ...
  const q = "DELETE FROM users WHERE usersId= ?"
...
app.post("/signIn", (req, res) => {
  const sql =
    "INSERT INTO users (`userFirst_name`,`usersLast_name`,`email`,`usersPassword`,`usersGeburtsjahr`) VALUES(?)";
